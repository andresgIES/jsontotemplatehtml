...
@Component({
  selector: "app-loterias-semanales",
  templateUrl: "./loterias-semanales.component.html",
  styleUrls: ["./loterias-semanales.component.css"]
})
export class LoteriasSemanalesComponent implements OnInit {
